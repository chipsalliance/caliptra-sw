...
pub mod meta {
    ...
    >;
    pub type CptraWdtTimer1TimeoutPeriod = ureg::ReadWriteReg32<0, u32, u32>;
    ...
    >;
    pub type CptraWdtTimer2TimeoutPeriod = ureg::ReadWriteReg32<0, u32, u32>;
    pub type CptraWdtStatus = ureg::ReadOnlyReg32<crate::soc_ifc::regs::CptraWdtStatusReadVal>;
