...
impl RegisterBlock {
    ...
    pub fn cptra_security_state(&self) -> ureg::RegRef<crate::soc_ifc::meta::CptraSecurityState> {
        unsafe { ureg::RegRef::new(self.0.wrapping_add(0x24 / core::mem::size_of::<u32>())) }
    }
    ...
    /// [br]SOC Access:      RW
    ///
    /// Read value: [`soc_ifc::regs::CptraTrngDoneReadVal`]; Write value: [`soc_ifc::regs::CptraTrngDoneWriteVal`]
    pub fn cptra_trng_done(&self) -> ureg::RegRef<crate::soc_ifc::meta::CptraTrngDone> {
...
pub mod regs {
    ...
    #[derive(Clone, Copy)]
    pub struct CptraTrngDoneReadVal(u32);
    impl CptraTrngDoneReadVal {
        ///
        #[inline(always)]
        pub fn done(&self) -> bool {
            ((self.0 >> 0) & 1) != 0
        ...
        /// Construct a WriteVal that can be used to modify the contents of this register value.
        pub fn modify(self) -> CptraTrngDoneWriteVal {
            CptraTrngDoneWriteVal(self.0)
        }
    }
    impl From<u32> for CptraTrngDoneReadVal {
        fn from(val: u32) -> Self {
            Self(val)
        }
    }
    impl From<CptraTrngDoneReadVal> for u32 {
        fn from(val: CptraTrngDoneReadVal) -> u32 {
            val.0
        }
    }
    #[derive(Clone, Copy)]
    pub struct CptraTrngDoneWriteVal(u32);
    impl CptraTrngDoneWriteVal {
        ///
        #[inline(always)]
        pub fn done(self, val: bool) -> Self {
            Self((self.0 & !(1 << 0)) | (u32::from(val) << 0))
    ...
    impl From<u32> for CptraTrngDoneWriteVal {
        fn from(val: u32) -> Self {
            Self(val)
        }
    }
    impl From<CptraTrngDoneWriteVal> for u32 {
        fn from(val: CptraTrngDoneWriteVal) -> u32 {
            val.0
        }
    }
    #[derive(Clone, Copy)]
...
pub mod meta {
    ...
    #[derive(Clone, Copy)]
    pub struct CptraTrngDone();
    impl ureg::RegType for CptraTrngDone {
        type Raw = u32;
    }
    impl ureg::ReadableReg for CptraTrngDone {
        type ReadVal = crate::soc_ifc::regs::CptraTrngDoneReadVal;
    }
    impl ureg::WritableReg for CptraTrngDone {
        type WriteVal = crate::soc_ifc::regs::CptraTrngDoneWriteVal;
    }
    impl ureg::ResettableReg for CptraTrngDone {
        const RESET_VAL: Self::Raw = 0;
    }
    #[derive(Clone, Copy)]
    ...
    #[derive(Clone, Copy)]
    pub struct FuseKeyManifestSvn();
    impl ureg::RegType for FuseKeyManifestSvn {
        type Raw = u32;
    }
    impl ureg::ReadableReg for FuseKeyManifestSvn {
        type ReadVal = u32;
    }
    impl ureg::WritableReg for FuseKeyManifestSvn {
        type WriteVal = u32;
    }
    impl ureg::ResettableReg for FuseKeyManifestSvn {
        const RESET_VAL: Self::Raw = 0;
    }
    #[derive(Clone, Copy)]
