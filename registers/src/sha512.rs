...
impl<TMmio: ureg::Mmio> RegisterBlock<TMmio> {
    ...
    /// [br]Sends all PCRs through SHA384 and stores the result in a dedicated register for signing.
    ///
    /// Read value: [`sha512::regs::GenPcrHashReadVal`]; Write value: [`sha512::regs::GenPcrHashWriteVal`]
    pub fn gen_pcr_hash(&self) -> ureg::RegRef<crate::sha512::meta::GenPcrHash, &TMmio> {
        unsafe {
            ureg::RegRef::new_with_mmio(
...
pub mod regs {
    ...
    #[derive(Clone, Copy)]
    pub struct GenPcrHashReadVal(u32);
    impl GenPcrHashReadVal {
        /// Setting this register starts the flow.
        #[inline(always)]
        pub fn flow_en(&self) -> bool {
            ((self.0 >> 0) & 1) != 0
        }
        /// Construct a WriteVal that can be used to modify the contents of this register value.
        pub fn modify(self) -> GenPcrHashWriteVal {
            GenPcrHashWriteVal(self.0)
        }
    }
    impl From<u32> for GenPcrHashReadVal {
        fn from(val: u32) -> Self {
            Self(val)
        }
    }
    impl From<GenPcrHashReadVal> for u32 {
        fn from(val: GenPcrHashReadVal) -> u32 {
            val.0
        }
    }
    #[derive(Clone, Copy)]
    pub struct GenPcrHashWriteVal(u32);
    impl GenPcrHashWriteVal {
        /// Setting this register starts the flow.
        #[inline(always)]
        pub fn flow_en(self, val: bool) -> Self {
            Self((self.0 & !(1 << 0)) | (u32::from(val) << 0))
        }
    }
    impl From<u32> for GenPcrHashWriteVal {
        fn from(val: u32) -> Self {
            Self(val)
        }
    }
    impl From<GenPcrHashWriteVal> for u32 {
        fn from(val: GenPcrHashWriteVal) -> u32 {
            val.0
        }
    }
    #[derive(Clone, Copy)]
...
pub mod meta {
    ...
    pub type GenPcrHash = ureg::ReadWriteReg32<
        0,
        crate::sha512::regs::GenPcrHashReadVal,
        crate::sha512::regs::GenPcrHashWriteVal,
    >;
}
