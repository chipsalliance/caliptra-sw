...
enum mailbox_command {
    ...
    OP_GET_IDEV_ECC384_CERT          = 0x49444543, // "IDEC"
    OP_GET_IDEV_ECC384_INFO          = 0x49444549, // "IDEI"
    OP_POPULATE_IDEV_ECC384_CERT     = 0x49444550, // "IDEP"
    OP_GET_LDEV_ECC384_CERT          = 0x4C444556, // "LDEV"
    OP_GET_FMC_ALIAS_ECC384_CERT     = 0x43455246, // "CERF"
    OP_GET_RT_ALIAS_ECC384_CERT      = 0x43455252, // "CERR"
    OP_GET_IDEV_ECC384_CSR           = 0x49444352, // "IDCR"
    OP_GET_IDEV_MLDSA87_CERT         = 0x49444D43, // "IDMC"
    OP_GET_IDEV_MLDSA87_INFO         = 0x49444D49, // "IDMI"
    OP_POPULATE_IDEV_MLDSA87_CERT    = 0x49444D50, // "IDMP"
    OP_GET_LDEV_MLDSA87_CERT         = 0x4C444D43, // "LDMC"
    OP_GET_FMC_ALIAS_MLDSA87_CERT    = 0x434D4346, // "CMRF"
    OP_GET_RT_ALIAS_MLDSA87_CERT     = 0x434D4352, // "CMCR"
    OP_GET_IDEV_MLDSA87_CSR          = 0x49444D52, // "IDMR"
    OP_ECDSA384_VERIFY               = 0x45435632, // "ECV2"
    OP_LMS_VERIFY                    = 0x4C4D5632, // "LMV2"
    OP_STASH_MEASUREMENT             = 0x4D454153, // "MEAS"
    OP_INVOKE_ECC384_DPE_COMMAND     = 0x44504543, // "DPEC"
    OP_INVOKE_MLDSA87_DPE_COMMAND    = 0x4450454D, // "DPEM"
    ...
    OP_QUOTE_PCRS_ECC384             = 0x50435251, // "PCRQ"
    OP_QUOTE_PCRS_MLDSA87            = 0x5043524D, // "PCRM"
    OP_EXTEND_PCR                    = 0x50435245, // "PCRE"
    OP_ADD_SUBJECT_ALT_NAME          = 0x414C544E, // "ALTN"
    OP_CERTIFY_KEY_EXTENDED_ECC384   = 0x434B4558, // "CKEX"
    OP_CERTIFY_KEY_EXTENDED_MLDSA87  = 0x434B584D, // "CKXM"
    ...
    OP_GET_FMC_ALIAS_ECC384_CSR      = 0x464D4352, // "FMCR"
    OP_GET_FMC_ALIAS_MLDSA87_CSR     = 0x464d4452, // "FMDR"
    ...
    OP_OCP_LOCK_REPORT_HEK_METADATA       = 0x52484D54, // "RHMT"
    OP_OCP_LOCK_GET_ALGORITHMS            = 0x47414C47, // "GALG"
    OP_OCP_LOCK_INITIALIZE_MEK_SECRET     = 0x494D4B53, // "IMKS"
    OP_OCP_LOCK_MIX_MPK                   = 0x4D4D504B, // "MMPK"
    OP_OCP_LOCK_DERIVE_MEK                = 0x444D454B, // "DMEK"
    OP_OCP_LOCK_ENUMERATE_HPKE_HANDLES    = 0x4548444C, // "EHDL"
    OP_OCP_LOCK_ROTATE_HPKE_KEY           = 0x5248504B, // "RHPK"
    OP_OCP_LOCK_GENERATE_MEK              = 0x474D454B, // "GMEK"
    OP_OCP_LOCK_GET_HPKE_PUB_KEY          = 0x4748504B, // "GHPK"
    OP_OCP_LOCK_GENERATE_MPK              = 0x474D504B, // "GMPK"
    OP_OCP_LOCK_REWRAP_MPK                = 0x52455750, // "REWP"
    OP_OCP_LOCK_ENABLE_MPK                = 0x524D504B, // "RMPK"
    OP_OCP_LOCK_TEST_ACCESS_KEY           = 0x5441434B, // "TACK"
    OP_OCP_LOCK_CLEAR_KEY_CACHE           = 0x434C4B43, // "CLKC"
    OP_OCP_LOCK_GET_STATUS                = 0x47535441, // "GSTA"
    OP_OCP_LOCK_UNLOAD_MEK                = 0x554D454B, // "UMEK"
    OP_OCP_LOCK_LOAD_MEK                  = 0x4C4D454B, // "LMEK"
};
