...
impl<TMmio: caliptra_ureg::Mmio> RegisterBlock<TMmio> {
    ...
    pub fn mbox_sram(
        &self,
    ) -> caliptra_ureg::Array<524288, caliptra_ureg::RegRef<crate::mcu_mbox0::meta::MboxSram, &TMmio>>
    {
        unsafe {
    ...
    #[inline(always)]
    pub fn mbox_lock(&self) -> caliptra_ureg::RegRef<crate::mcu_mbox0::meta::MboxLock, &TMmio> {
        unsafe {
    ...
    /// Read value: [`u32`]; Write value: [`u32`]
    #[inline(always)]
    pub fn mbox_user(&self) -> caliptra_ureg::RegRef<crate::mcu_mbox0::meta::MboxUser, &TMmio> {
        unsafe {
            caliptra_ureg::RegRef::new_with_mmio(
                self.ptr
    ...
    pub fn mbox_target_user(
        &self,
    ) -> caliptra_ureg::RegRef<crate::mcu_mbox0::meta::MboxTargetUser, &TMmio> {
        unsafe {
            caliptra_ureg::RegRef::new_with_mmio(
                self.ptr
    ...
    pub fn mbox_target_user_valid(
        &self,
    ) -> caliptra_ureg::RegRef<crate::mcu_mbox0::meta::MboxTargetUserValid, &TMmio> {
        unsafe {
            caliptra_ureg::RegRef::new_with_mmio(
                self.ptr
    ...
    /// Read value: [`u32`]; Write value: [`u32`]
    #[inline(always)]
    pub fn mbox_cmd(&self) -> caliptra_ureg::RegRef<crate::mcu_mbox0::meta::MboxCmd, &TMmio> {
        unsafe {
            caliptra_ureg::RegRef::new_with_mmio(
                self.ptr
    ...
    /// Read value: [`u32`]; Write value: [`u32`]
    #[inline(always)]
    pub fn mbox_dlen(&self) -> caliptra_ureg::RegRef<crate::mcu_mbox0::meta::MboxDlen, &TMmio> {
        unsafe {
            caliptra_ureg::RegRef::new_with_mmio(
                self.ptr
    ...
    pub fn mbox_execute(
        &self,
    ) -> caliptra_ureg::RegRef<crate::mcu_mbox0::meta::MboxExecute, &TMmio> {
        unsafe {
            caliptra_ureg::RegRef::new_with_mmio(
                self.ptr
    ...
    pub fn mbox_target_status(
        &self,
    ) -> caliptra_ureg::RegRef<crate::mcu_mbox0::meta::MboxTargetStatus, &TMmio> {
        unsafe {
            caliptra_ureg::RegRef::new_with_mmio(
                self.ptr
    ...
    pub fn mbox_cmd_status(
        &self,
    ) -> caliptra_ureg::RegRef<crate::mcu_mbox0::meta::MboxCmdStatus, &TMmio> {
        unsafe {
            caliptra_ureg::RegRef::new_with_mmio(
                self.ptr
    ...
    pub fn mbox_hw_status(
        &self,
    ) -> caliptra_ureg::RegRef<crate::mcu_mbox0::meta::MboxHwStatus, &TMmio> {
        unsafe {
            caliptra_ureg::RegRef::new_with_mmio(
                self.ptr
...
pub mod meta {
    ...
    pub type MboxLock = caliptra_ureg::ReadOnlyReg32<crate::mcu_mbox0::regs::MboxLockReadVal>;
    ...
    pub type MboxHwStatus =
        caliptra_ureg::ReadOnlyReg32<crate::mcu_mbox0::regs::MboxHwStatusReadVal>;
}
