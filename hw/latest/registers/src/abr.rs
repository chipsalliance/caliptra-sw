...
impl<TMmio: ureg::Mmio> RegisterBlock<TMmio> {
    ...
    pub fn kv_mldsa_seed_rd_ctrl(
        ...
        unsafe {
            ureg::RegRef::new_with_mmio(
                self.ptr.wrapping_add(0x7320 / core::mem::size_of::<u32>()),
                core::borrow::Borrow::borrow(&self.mmio),
            )
        }
    }
    ...
    pub fn kv_mldsa_seed_rd_status(
        ...
        unsafe {
            ureg::RegRef::new_with_mmio(
                self.ptr.wrapping_add(0x7324 / core::mem::size_of::<u32>()),
                core::borrow::Borrow::borrow(&self.mmio),
            )
        }
    }
    ...
    pub fn mlkem_version(
        ...
        unsafe {
            ureg::Array::new_with_mmio(
                self.ptr.wrapping_add(0x8008 / core::mem::size_of::<u32>()),
                core::borrow::Borrow::borrow(&self.mmio),
            )
        }
    }
    ...
    pub fn mlkem_ctrl(&self) -> ureg::RegRef<crate::abr::meta::MlkemCtrl, &TMmio> {
        unsafe {
            ureg::RegRef::new_with_mmio(
                self.ptr.wrapping_add(0x8010 / core::mem::size_of::<u32>()),
                core::borrow::Borrow::borrow(&self.mmio),
            )
        }
    }
    ...
    pub fn mlkem_status(&self) -> ureg::RegRef<crate::abr::meta::MlkemStatus, &TMmio> {
        unsafe {
            ureg::RegRef::new_with_mmio(
                self.ptr.wrapping_add(0x8014 / core::mem::size_of::<u32>()),
                core::borrow::Borrow::borrow(&self.mmio),
            )
        }
    }
    ...
    pub fn mlkem_seed_d(
        ...
        unsafe {
            ureg::Array::new_with_mmio(
                self.ptr.wrapping_add(0x8018 / core::mem::size_of::<u32>()),
                core::borrow::Borrow::borrow(&self.mmio),
            )
        }
    }
    ...
    pub fn mlkem_seed_z(
        ...
        unsafe {
            ureg::Array::new_with_mmio(
                self.ptr.wrapping_add(0x8038 / core::mem::size_of::<u32>()),
                core::borrow::Borrow::borrow(&self.mmio),
            )
        }
    }
    ...
    pub fn mlkem_shared_key(
        ...
        unsafe {
            ureg::Array::new_with_mmio(
                self.ptr.wrapping_add(0x8058 / core::mem::size_of::<u32>()),
                core::borrow::Borrow::borrow(&self.mmio),
            )
        }
    }
    ...
    pub fn mlkem_msg(&self) -> ureg::Array<8, ureg::RegRef<crate::abr::meta::MlkemMsg, &TMmio>> {
        unsafe {
            ureg::Array::new_with_mmio(
                self.ptr.wrapping_add(0x8080 / core::mem::size_of::<u32>()),
                core::borrow::Borrow::borrow(&self.mmio),
            )
        }
    }
