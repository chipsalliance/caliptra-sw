...
impl<TMmio: caliptra_ureg::Mmio> RegisterBlock<TMmio> {
    ...
    pub fn key_ctrl(
        &self,
    ) -> caliptra_ureg::Array<24, caliptra_ureg::RegRef<crate::kv::meta::KeyCtrl, &TMmio>> {
        unsafe {
    ...
    pub fn key_entry(
        ...
        24,
        caliptra_ureg::Array<16, caliptra_ureg::RegRef<crate::kv::meta::KeyEntry, &TMmio>>,
    > {
        unsafe {
            caliptra_ureg::Array::new_with_mmio(
    ...
    #[inline(always)]
    pub fn clear_secrets(&self) -> caliptra_ureg::RegRef<crate::kv::meta::ClearSecrets, &TMmio> {
        unsafe {
...
pub mod meta {
    ...
    pub type KeyCtrl = caliptra_ureg::ReadWriteReg32<
        0,
        crate::kv::regs::KvctrlReadVal,
        crate::kv::regs::KvctrlWriteVal,
    >;
    pub type KeyEntry = caliptra_ureg::WriteOnlyReg32<0, u32>;
    pub type ClearSecrets = caliptra_ureg::ReadWriteReg32<
        0,
