...
//
// generated by caliptra_registers_generator with caliptra-rtl repo at f3eb7a8efed98e0d0028e6470ce43a882b3fae09
//
...
impl<TMmio: ureg::Mmio> RegisterBlock<TMmio> {
    ...
    /// Key Manifest Mask Fuse (ECC Revocation).
    /// [br]Caliptra Access: RO
    /// [br]SOC Access:      RWL-S
    ///
    /// Read value: [`u32`]; Write value: [`u32`]
    ...
    pub fn fuse_key_manifest_pk_hash_mask(
        &self,
    ) -> ureg::Array<8, ureg::RegRef<crate::soc_ifc::meta::FuseKeyManifestPkHashMask, &TMmio>> {
        unsafe {
            ureg::Array::new_with_mmio(
...
pub mod meta {
    ...
    pub type FuseKeyManifestPkHashMask = ureg::ReadWriteReg32<0, u32, u32>;
