...
impl<TMmio: ureg::Mmio> RegisterBlock<TMmio> {
    ...
    pub fn ss_dbg_manuf_service_reg_req(
        &self,
    ) -> ureg::RegRef<crate::soc_ifc::meta::SsDbgManufServiceRegReq, &TMmio> {
        unsafe {
            ureg::RegRef::new_with_mmio(
    ...
    pub fn ss_dbg_manuf_service_reg_rsp(
        &self,
    ) -> ureg::RegRef<crate::soc_ifc::meta::SsDbgManufServiceRegRsp, &TMmio> {
        unsafe {
            ureg::RegRef::new_with_mmio(
...
pub mod meta {
    ...
    pub type SsDbgManufServiceRegReq = ureg::ReadWriteReg32<
        0,
