...
//
// generated by caliptra_registers_generator with caliptra-rtl repo at 22f402e4858c198ac45541ecc9e14f471d0d0fd5
//
...
impl<TMmio: caliptra_ureg::Mmio> RegisterBlock<TMmio> {
    ...
    ///
    /// Read value: [`soc_ifc::regs::SsDbgManufServiceRegReqReadVal`]; Write value: [`soc_ifc::regs::SsDbgManufServiceRegReqWriteVal`]
    #[inline(always)]
    pub fn ss_dbg_manuf_service_reg_req(
        &self,
    ) -> caliptra_ureg::RegRef<crate::soc_ifc::meta::SsDbgManufServiceRegReq, &TMmio> {
        unsafe {
            caliptra_ureg::RegRef::new_with_mmio(
    ...
    /// [br]TAP Access [in debug/manuf mode]: RO
    ///
    /// Read value: [`soc_ifc::regs::SsDbgManufServiceRegRspReadVal`]; Write value: [`soc_ifc::regs::SsDbgManufServiceRegRspWriteVal`]
    #[inline(always)]
    pub fn ss_dbg_manuf_service_reg_rsp(
        &self,
    ) -> caliptra_ureg::RegRef<crate::soc_ifc::meta::SsDbgManufServiceRegRsp, &TMmio> {
        unsafe {
            caliptra_ureg::RegRef::new_with_mmio(
...
pub mod regs {
    ...
    #[derive(Clone, Copy)]
    pub struct SsDbgManufServiceRegReqReadVal(u32);
    impl SsDbgManufServiceRegReqReadVal {
        ...
        /// Construct a WriteVal that can be used to modify the contents of this register value.
        #[inline(always)]
        pub fn modify(self) -> SsDbgManufServiceRegReqWriteVal {
            SsDbgManufServiceRegReqWriteVal(self.0)
        }
    }
    impl From<u32> for SsDbgManufServiceRegReqReadVal {
        #[inline(always)]
        fn from(val: u32) -> Self {
            Self(val)
        }
    }
    impl From<SsDbgManufServiceRegReqReadVal> for u32 {
        #[inline(always)]
        fn from(val: SsDbgManufServiceRegReqReadVal) -> u32 {
            val.0
        }
    }
    #[derive(Clone, Copy)]
    pub struct SsDbgManufServiceRegReqWriteVal(u32);
    impl SsDbgManufServiceRegReqWriteVal {
        /// Manufacturing debug unlock request. Only writable when lifecycle state
        /// is MANUFACTURING and DEBUG_INTENT strap is set to 1.
        /// [br]Caliptra Access: RW
        /// [br]SOC Access:      RW
    ...
    impl From<u32> for SsDbgManufServiceRegReqWriteVal {
        #[inline(always)]
        fn from(val: u32) -> Self {
            Self(val)
        }
    }
    impl From<SsDbgManufServiceRegReqWriteVal> for u32 {
        #[inline(always)]
        fn from(val: SsDbgManufServiceRegReqWriteVal) -> u32 {
            val.0
        }
    }
    #[derive(Clone, Copy)]
    pub struct SsDbgManufServiceRegRspReadVal(u32);
    impl SsDbgManufServiceRegRspReadVal {
        ...
        /// Construct a WriteVal that can be used to modify the contents of this register value.
        #[inline(always)]
        pub fn modify(self) -> SsDbgManufServiceRegRspWriteVal {
            SsDbgManufServiceRegRspWriteVal(self.0)
        }
    }
    impl From<u32> for SsDbgManufServiceRegRspReadVal {
        #[inline(always)]
        fn from(val: u32) -> Self {
            Self(val)
        }
    }
    impl From<SsDbgManufServiceRegRspReadVal> for u32 {
        #[inline(always)]
        fn from(val: SsDbgManufServiceRegRspReadVal) -> u32 {
            val.0
        }
    }
    #[derive(Clone, Copy)]
    pub struct SsDbgManufServiceRegRspWriteVal(u32);
    impl SsDbgManufServiceRegRspWriteVal {
        /// Manufacturing debug unlock was successful. Only writable by Caliptra, and only when lifecycle state is MANUFACTURING and DEBUG_INTENT strap is set to 1. Sticky once set, until warm reset.
        #[inline(always)]
    ...
    impl From<u32> for SsDbgManufServiceRegRspWriteVal {
        #[inline(always)]
        fn from(val: u32) -> Self {
            Self(val)
        }
    }
    impl From<SsDbgManufServiceRegRspWriteVal> for u32 {
        #[inline(always)]
        fn from(val: SsDbgManufServiceRegRspWriteVal) -> u32 {
            val.0
        }
    }
    #[derive(Clone, Copy)]
...
pub mod meta {
    ...
    pub type SsDbgManufServiceRegReq = caliptra_ureg::ReadWriteReg32<
        0,
        crate::soc_ifc::regs::SsDbgManufServiceRegReqReadVal,
        crate::soc_ifc::regs::SsDbgManufServiceRegReqWriteVal,
    >;
    pub type SsDbgManufServiceRegRsp = caliptra_ureg::ReadWriteReg32<
        0,
        crate::soc_ifc::regs::SsDbgManufServiceRegRspReadVal,
        crate::soc_ifc::regs::SsDbgManufServiceRegRspWriteVal,
    >;
