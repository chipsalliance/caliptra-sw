...
//
// generated by caliptra_registers_generator with caliptra-rtl repo at 234a09993120d436e441827ad2f500154ec4f36a
//
...
impl<TMmio: ureg::Mmio> RegisterBlock<TMmio> {
    ...
    /// 12 32-bit registers storing the 384-bit key in big-endian representation.
    ///
    /// Read value: [`u32`]; Write value: [`u32`]
    #[inline(always)]
    ...
    /// 12 32-bit registers storing the 384-bit digest output in big-endian representation.
    ///
    /// Read value: [`u32`]; Write value: [`u32`]
    #[inline(always)]
    ...
    /// HMAC384 component lfsr seed register type definition
    /// 12 32-bit registers storing the 384-bit lfsr seed input.
    ///
    /// Read value: [`u32`]; Write value: [`u32`]
    #[inline(always)]
    pub fn lfsr_seed(&self) -> ureg::Array<12, ureg::RegRef<crate::hmac::meta::LfsrSeed, &TMmio>> {
        unsafe {
            ureg::Array::new_with_mmio(
...
pub mod regs {
    ...
    impl CtrlWriteVal {
        /// Control init command bit: Trigs the HMAC384 core to start the
        ...
        /// Control next command bit: ​Trigs the HMAC384 core to start the
