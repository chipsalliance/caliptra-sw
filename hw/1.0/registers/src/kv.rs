...
pub mod regs {
    ...
    impl KvctrlWriteVal {
        ...
        /// [br]dest_valid[7] = rsvd
        #[inline(always)]
        pub fn dest_valid(self, val: u32) -> Self {
            Self((self.0 & !(0xff << 9)) | ((val & 0xff) << 9))
        }
        /// Stores the offset of the last valid dword, used to indicate last cycle on reads.
        #[inline(always)]
        pub fn last_dword(self, val: u32) -> Self {
            Self((self.0 & !(0xf << 17)) | ((val & 0xf) << 17))
        }
    }
...
pub mod meta {
    ...
    pub type KeyEntry = ureg::ReadWriteReg32<0, u32, u32>;
