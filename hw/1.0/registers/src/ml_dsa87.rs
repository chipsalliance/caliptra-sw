...
impl<TMmio: ureg::Mmio> RegisterBlock<TMmio> {
    ...
    #[inline(always)]
    pub fn kv_rd_seed_ctrl(&self) -> ureg::RegRef<crate::ml_dsa87::meta::KvRdSeedCtrl, &TMmio> {
        unsafe {
            ureg::RegRef::new_with_mmio(
                self.ptr.wrapping_add(0x4614 / core::mem::size_of::<u32>()),
                core::borrow::Borrow::borrow(&self.mmio),
            )
        }
    }
    ...
    #[inline(always)]
    pub fn kv_rd_seed_status(&self) -> ureg::RegRef<crate::ml_dsa87::meta::KvRdSeedStatus, &TMmio> {
        unsafe {
            ureg::RegRef::new_with_mmio(
                self.ptr.wrapping_add(0x4618 / core::mem::size_of::<u32>()),
                core::borrow::Borrow::borrow(&self.mmio),
            )
        }
    }
