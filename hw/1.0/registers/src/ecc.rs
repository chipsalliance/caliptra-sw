...
//
// generated by caliptra_registers_generator with caliptra-rtl repo at 9fe83dd08d6c30901914ce94de44eee425c64790
//
...
impl EccReg {
    pub const PTR: *mut u32 = 0x1003c000 as *mut u32;
    /// # Safety
    ///
...
impl<TMmio: ureg::Mmio> RegisterBlock<TMmio> {
    ...
    /// 12 32-bit registers storing the random lambda value.
    /// These registers are read by ECC user after HMAC_DRBG has
    /// finished generation of random values.
    /// The lambda value is to be used to randomize projective
    /// coordinates of the base point G as (Gx*Z, Gy*Z, Z).
    /// These registers are located at ECC_base_address +
    /// 0x0000_0200 to 0x0000_022C in big-endian representation.
    ///
    /// Read value: [`u32`]; Write value: [`u32`]
    #[inline(always)]
    pub fn lambda(&self) -> ureg::Array<12, ureg::RegRef<crate::ecc::meta::Lambda, &TMmio>> {
        unsafe {
            ureg::Array::new_with_mmio(
    ...
    /// 6 32-bit registers storing a random for scalar blinding.
    /// These registers are read by ECC user after HMAC_DRBG has
    /// finished generation of random values.
    /// This random value may be multiplied by the group order of
    /// the curve and then added to a scalar value. A resulting
    /// randomized 576-bit value is then used for keygen and sign
    /// to thwart RPA/ZPA.
    /// These registers are located at ECC_base_address +
    /// 0x0000_0280 to 0x0000_0294 in big-endian representation.
    ///
    /// Read value: [`u32`]; Write value: [`u32`]
    #[inline(always)]
    pub fn scalar_rnd(&self) -> ureg::Array<6, ureg::RegRef<crate::ecc::meta::ScalarRnd, &TMmio>> {
        unsafe {
            ureg::Array::new_with_mmio(
...
pub mod meta {
    ...
    pub type Lambda = ureg::ReadOnlyReg32<u32>;
    pub type ScalarRnd = ureg::ReadOnlyReg32<u32>;
