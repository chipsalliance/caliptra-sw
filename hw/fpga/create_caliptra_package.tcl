...
remove_files [ glob $fpgaDir/src/kv_reg.sv ]


if {$DISABLE_ECC} {
  # Remove ECC to be replaced by stub for SS
  remove_files [ glob $rtlDir/src/ecc/rtl/*.sv ]
} else {
...
#set_property file_type SystemVerilog [get_files $rtlDir/src/riscv_core/veer_el2/rtl/pic_map_auto.h]
