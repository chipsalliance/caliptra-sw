...
/// The Firmware Handoff Table is a data structure that is resident  at a well-known location in DCCM.
/// It is initially populated by ROM and modified by FMC as a way to pass parameters and configuration information
...
impl FirmwareHandoffTable {
    ...
    pub fn try_load() -> Option<FirmwareHandoffTable> {
        ...
        fht.as_bytes_mut().copy_from_slice(slice);
