...
pub mod ocp_lock {
    ...
    pub const KEY_ID_VEK: KeyId = KeyId::KeyId18;
    pub const KEY_ID_LOCKED_MPK_ENCRYPTION_KEY: KeyId = KeyId::KeyId19;
    pub const KEY_ID_MEK_SECRETS: KeyId = KeyId::KeyId21;
