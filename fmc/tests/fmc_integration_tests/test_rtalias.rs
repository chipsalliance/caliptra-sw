...
const RT_HASH_CHAIN_COMPLETE: u32 = 0x400;
const RT_ALIAS_MEASUREMENT_COMPLETE: u32 = 0x401;
const RT_ALIAS_DERIVED_CDI_COMPLETE: u32 = 0x402;
const RT_ALIAS_KEY_PAIR_DERIVATION_COMPLETE: u32 = 0x403;
const RT_ALIAS_SUBJ_ID_SN_GENERATION_COMPLETE: u32 = 0x404;
const RT_ALIAS_SUBJ_KEY_ID_GENERATION_COMPLETE: u32 = 0x405;
const RT_ALIAS_CERT_SIG_GENERATION_COMPLETE: u32 = 0x406;
const RT_ALIAS_DERIVATION_COMPLETE: u32 = 0x407;
