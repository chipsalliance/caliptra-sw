...
impl CaliptraError {
    ...
    pub const FMC_HANDOFF_INVALID_PARAM: CaliptraError = CaliptraError::new_const(0x000F0003);
    pub const FMC_GLOBAL_NMI: CaliptraError = CaliptraError::new_const(0x000F0004);
    pub const FMC_GLOBAL_EXCEPTION: CaliptraError = CaliptraError::new_const(0x000F0005);
    pub const FMC_GLOBAL_PANIC: CaliptraError = CaliptraError::new_const(0x000F0006);
