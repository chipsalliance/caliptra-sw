...
fn test_doe_when_debug_locked() {
    ...
    // assert_eq!(
    //     test_results.hmac_uds_as_data_out_pub,
    //     DOE_TEST_VECTORS.expected_test_results.hmac_uds_as_data_out_pub
    // );

    // assert_eq!(
    //     test_results.hmac_field_entropy_as_key_out_pub,
    //     DOE_TEST_VECTORS.expected_test_results.hmac_field_entropy_as_key_out_pub
    // );

    // assert_eq!(
    //     test_results.hmac_field_entropy_as_data_out_pub,
    //     DOE_TEST_VECTORS.expected_test_results.hmac_field_entropy_as_data_out_pub
    // );
