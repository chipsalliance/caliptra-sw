...
use caliptra_drivers::{
    hmac_kdf, hmac_kdf_expand, hmac_kdf_extract, Array4x12, Array4x16, Ecc384, Ecc384PrivKeyOut,
    Ecc384Scalar, Ecc384Seed, Hmac, HmacMode, KeyId, KeyReadArgs, KeyUsage, KeyWriteArgs, Trng,
};
...
fn test_hkdf() {
    ...
    let ikm = [
        0x58, 0x3a, 0x07, 0x9d, 0xf3, 0x37, 0x70, 0x57, 0x4e, 0x72, 0xaf, 0x11, 0x45, 0x67, 0x2c,
        0xc3, 0x63, 0xe6, 0xfa, 0x20, 0x7d, 0x91, 0x71, 0x2b, 0x53, 0x49, 0x0b, 0x90, 0x4d, 0x91,
        0x31, 0xbf, 0xdc, 0x9b, 0xf4, 0x91, 0xd5, 0x80, 0x2e, 0xfc, 0xbc, 0xb3, 0xf9, 0x47, 0x9e,
        0xac, 0x0f, 0x2c,
    ];
    let salt = [
        0x43, 0x48, 0xac, 0xc2, 0xb7, 0x7c, 0x0a, 0x51, 0x03, 0x4c, 0xe5, 0xb3, 0x3f, 0xea, 0x9b,
        0xe3, 0x9e, 0xcb, 0xa7, 0x4f, 0xcd, 0xb3, 0xa1, 0xae, 0xdd, 0x81, 0xba, 0xf2, 0x9e, 0x10,
        0x99, 0x14, 0xeb, 0x88, 0x61, 0x8b, 0x06, 0x08, 0x97, 0x1c, 0x8b, 0xc8, 0xa5, 0xde, 0x02,
        0x6c, 0xe9, 0x48,
    ];
    let info = [
        0xd5, 0x70, 0xd1, 0x95, 0x89, 0xe5, 0xc0, 0xdd, 0xe5, 0xaf, 0xee, 0x14, 0x2a, 0x05, 0xdb,
        0x06, 0x49, 0x65, 0xa1, 0x89, 0x74, 0x71, 0xf4, 0x10, 0x36, 0x34, 0x3d, 0x41, 0x35, 0x87,
        0xb4, 0x82, 0xb7, 0x86, 0x2f, 0x0d, 0xd0, 0x0d, 0xca, 0x98, 0x98, 0x5b, 0x3d, 0xa4, 0x89,
        0x83, 0x9f, 0x36,
    ];
    let expected_prk = [
        0x9b, 0xaa, 0x8f, 0x4e, 0x38, 0x33, 0x9a, 0x7a, 0xb9, 0x41, 0x17, 0x2f, 0xcf, 0xce, 0x0c,
        0x7d, 0xc4, 0xf5, 0x33, 0x44, 0x36, 0x32, 0xa2, 0x05, 0x65, 0xd5, 0x5f, 0x9d, 0x16, 0xf4,
        0xf1, 0x0e, 0xcf, 0xf3, 0xc3, 0x65, 0xd4, 0xc7, 0x85, 0x15, 0xe8, 0x68, 0x4b, 0x70, 0x24,
        0x46, 0x40, 0x3b,
    ];
    let expected_okm = [
        0x49, 0x8e, 0x2c, 0x57, 0x5b, 0x59, 0xa6, 0x01, 0x62, 0xf0, 0xd1, 0x42, 0x7c, 0x39, 0x3e,
        0x2a, 0x8d, 0xd8, 0x47, 0x44, 0x72, 0x0b, 0x93, 0x63, 0x22, 0x75, 0xe0, 0xaa, 0xf6, 0xf6,
        0xb7, 0x07, 0x05, 0x95, 0x68, 0xb6, 0xa9, 0xa1, 0xd4, 0xc5, 0xc0, 0x38, 0xfe, 0x34, 0x8c,
        0x47, 0xf5, 0xff,
    ];
    ...
    hmac_kdf_extract(
        &mut hmac,
        &ikm,
        Some(&Array4x12::from(salt)),
        &mut trng,
        &mut prk,
    )
    .unwrap();

    assert_eq!(prk, Array4x12::from(expected_prk));

    let okm = hmac_kdf_expand::<48>(&mut hmac, &prk, Some(&info), &mut trng).unwrap();

    assert_eq!(<[u8; 48]>::from(okm), expected_okm);
}
...
fn test_hkdf_no_salt() {
    ...
    let ikm = [
        0xe5, 0xd8, 0x51, 0x85, 0x15, 0xa9, 0x9c, 0x38, 0xf6, 0xd5, 0xc1, 0xae, 0x0f, 0x94, 0x0b,
        0xa1, 0x82, 0xa7, 0x0e, 0x14, 0xb9, 0xea, 0x5e, 0xdf, 0xdc, 0xbd, 0x6b, 0x53, 0x3e, 0xbf,
        0xeb, 0x4a, 0xbf, 0x91, 0xa2, 0xbb, 0xfe, 0xae, 0xd0, 0x3e, 0xb9, 0xe3, 0xa3, 0xa4, 0xfe,
        0x57, 0x7c, 0x39,
    ];
    let info = [
        0x40, 0x6c, 0x4b, 0x24, 0xcf, 0x1a, 0xf6, 0x2f, 0x92, 0xa5, 0x38, 0xbb, 0x96, 0xa8, 0xe5,
        0xbc, 0x19, 0x58, 0xc2, 0xdd, 0x98, 0xcb, 0x46, 0xf6, 0x96, 0xcc, 0x62, 0x69, 0x04, 0x67,
        0x1e, 0x17, 0x97, 0x8e, 0x27, 0x7e, 0x03, 0x7b, 0xe2, 0xb1, 0xfb, 0xdd, 0x4a, 0x71, 0x79,
        0xdc, 0x40, 0xc1,
    ];
    let expected_prk = [
        0x8a, 0xeb, 0x0e, 0xf3, 0x11, 0xb1, 0xd5, 0x70, 0xaa, 0x04, 0xd1, 0x6d, 0xa4, 0xbc, 0xa8,
        0x87, 0x73, 0x7c, 0xa2, 0xe2, 0x14, 0x82, 0x9d, 0x5b, 0xa8, 0x74, 0x8d, 0x20, 0x44, 0xbb,
        0xb1, 0xfe, 0x88, 0x29, 0xbe, 0xc9, 0x8b, 0x4a, 0x5f, 0xe0, 0xd3, 0xa8, 0x40, 0xc9, 0x07,
        0x1b, 0x3b, 0x9c,
    ];
    let expected_okm = [
        0xe3, 0xca, 0xc3, 0x7c, 0x89, 0x85, 0x6f, 0xe9, 0x4f, 0x3f, 0x0e, 0xc9, 0x91, 0xf8, 0x6e,
        0x32, 0xb8, 0x6d, 0xab, 0x50, 0x90, 0x68, 0x96, 0xa5, 0xf6, 0x0f, 0x3d, 0x03, 0x63, 0x04,
        0x78, 0xb9, 0xca, 0x13, 0x1b, 0x8e, 0xa7, 0x60, 0xd0, 0xf7, 0x91, 0xea, 0xa7, 0xb7, 0xca,
        0x1c, 0x09, 0xc2,
    ];

    let mut prk = Array4x12::default();
    hmac_kdf_extract(&mut hmac384, &ikm, None, &mut trng, &mut prk).unwrap();

    assert_eq!(prk, Array4x12::from(expected_prk));

    let okm = hmac_kdf_expand::<48>(&mut hmac384, &prk, Some(&info), &mut trng).unwrap();
    assert_eq!(<[u8; 48]>::from(okm), expected_okm);
}
