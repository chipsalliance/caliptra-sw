...
impl DataVault {
    ...
    pub fn set_vendor_lms_pk_index(&mut self, index: u32) {
        self.cold_reset_entries.vendor_lms_pk_index = index;
    }

    /// Get the vendor LMS public key index used for image verification.
    ///
    /// # Returns
    ///
    /// * `u32` - Vendor LMS public key index
    pub fn vendor_lms_pk_index(&self) -> u32 {
        self.cold_reset_entries.vendor_lms_pk_index
    }
