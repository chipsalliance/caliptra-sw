...
impl FmcAliasCertTbsMlDsa87 {
    ...
    const TCB_INFO_DEVICE_INFO_HASH_OFFSET: usize = 3050usize;
    const TCB_INFO_FMC_TCI_OFFSET: usize = 3149usize;
    const SERIAL_NUMBER_OFFSET: usize = 11usize;
    const SUBJECT_KEY_ID_OFFSET: usize = 3218usize;
    const AUTHORITY_KEY_ID_OFFSET: usize = 3251usize;
    const UEID_OFFSET: usize = 2986usize;
    const NOT_BEFORE_OFFSET: usize = 163usize;
    const NOT_AFTER_OFFSET: usize = 178usize;
    const TCB_INFO_FLAGS_OFFSET: usize = 3101usize;
    const TCB_INFO_FW_SVN_OFFSET: usize = 3130usize;
    const TCB_INFO_FW_SVN_FUSES_OFFSET: usize = 3031usize;
