...
impl FmcAliasCertTbsEcc384 {
    ...
    const PCR_SIGNING_KEY_DIGEST_OFFSET: usize = 554usize;
    const TCB_INFO_OWNER_DEVICE_INFO_HASH_OFFSET: usize = 641usize;
    const TCB_INFO_VENDOR_DEVICE_INFO_HASH_OFFSET: usize = 738usize;
    const TCB_INFO_FMC_TCI_OFFSET: usize = 840usize;
    const SERIAL_NUMBER_OFFSET: usize = 11usize;
    const SUBJECT_KEY_ID_OFFSET: usize = 931usize;
    const AUTHORITY_KEY_ID_OFFSET: usize = 964usize;
    const UEID_OFFSET: usize = 490usize;
    const NOT_BEFORE_OFFSET: usize = 161usize;
    const NOT_AFTER_OFFSET: usize = 178usize;
    const TCB_INFO_FW_SVN_OFFSET: usize = 822usize;
    ...
    pub const TBS_TEMPLATE_LEN: usize = 984usize;
    const TBS_TEMPLATE_BEFORE_KEY: [u8; Self::PUBLIC_KEY_OFFSET] = [
        48u8, 130u8, 3u8, 212u8, 160u8, 3u8, 2u8, 1u8, 2u8, 2u8, 20u8, 95u8, 95u8, 95u8, 95u8,
    ...
    const TBS_TEMPLATE_AFTER_KEY: [u8; Self::TBS_TEMPLATE_AFTER_KEY_LEN] = [
        ...
        43u8, 6u8, 1u8, 4u8, 1u8, 130u8, 204u8, 127u8, 2u8, 1u8, 4u8, 50u8, 4u8, 48u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
