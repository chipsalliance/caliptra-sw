...
impl RtAliasCsrTbsEcc384 {
    ...
    const TCB_INFO_RT_TCI_OFFSET: usize = 395usize;
    const UEID_OFFSET: usize = 323usize;
    const TCB_INFO_FW_SVN_OFFSET: usize = 377usize;
    ...
    pub const TBS_TEMPLATE_LEN: usize = 474usize;
    const TBS_TEMPLATE_BEFORE_KEY: [u8; Self::PUBLIC_KEY_OFFSET] = [
        48u8, 130u8, 1u8, 214u8, 2u8, 1u8, 0u8, 48u8, 119u8, 49u8, 42u8, 48u8, 40u8, 6u8, 3u8,
