...
impl OcpLockMlKemCertTbsEcc384 {
    const PUBLIC_KEY_OFFSET: usize = 347usize;
    const SUBJECT_SN_OFFSET: usize = 261usize;
    const ISSUER_SN_OFFSET: usize = 100usize;
    const SERIAL_NUMBER_OFFSET: usize = 11usize;
    const SUBJECT_KEY_ID_OFFSET: usize = 1986usize;
    const AUTHORITY_KEY_ID_OFFSET: usize = 2019usize;
    ...
    pub const TBS_TEMPLATE_LEN: usize = 2039usize;
    const TBS_TEMPLATE_BEFORE_KEY: [u8; Self::PUBLIC_KEY_OFFSET] = [
        48u8, 130u8, 7u8, 243u8, 160u8, 3u8, 2u8, 1u8, 2u8, 2u8, 20u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 48u8, 10u8, 6u8, 8u8, 42u8, 134u8, 72u8, 206u8, 61u8, 4u8, 3u8, 3u8, 48u8, 119u8,
        49u8, 42u8, 48u8, 40u8, 6u8, 3u8, 85u8, 4u8, 3u8, 12u8, 33u8, 67u8, 97u8, 108u8, 105u8,
        112u8, 116u8, 114u8, 97u8, 32u8, 70u8, 87u8, 32u8, 50u8, 46u8, 49u8, 46u8, 48u8, 32u8,
        69u8, 99u8, 99u8, 51u8, 56u8, 52u8, 32u8, 82u8, 116u8, 32u8, 65u8, 108u8, 105u8, 97u8,
        115u8, 49u8, 73u8, 48u8, 71u8, 6u8, 3u8, 85u8, 4u8, 5u8, 19u8, 64u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 48u8, 34u8, 24u8, 15u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 24u8, 15u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 48u8, 123u8, 49u8, 46u8, 48u8, 44u8, 6u8, 3u8,
        85u8, 4u8, 3u8, 12u8, 37u8, 79u8, 67u8, 80u8, 32u8, 76u8, 79u8, 67u8, 75u8, 32u8, 72u8,
        80u8, 75u8, 69u8, 32u8, 69u8, 110u8, 100u8, 111u8, 114u8, 115u8, 101u8, 109u8, 101u8,
        110u8, 116u8, 32u8, 77u8, 76u8, 45u8, 75u8, 69u8, 77u8, 32u8, 49u8, 48u8, 50u8, 52u8, 49u8,
        ...
        6u8, 50u8, 48u8, 11u8, 6u8, 9u8, 96u8, 134u8, 72u8, 1u8, 101u8, 3u8, 4u8, 4u8, 3u8, 3u8,
        130u8, 6u8, 33u8, 0u8,
    ];
