...
//use crate::csr_rustcrypto as csr;

#[cfg(feature = "openssl")]
use crate::cert_openssl as cert;
#[cfg(feature = "openssl")]
use crate::csr_openssl as csr;
#[cfg(feature = "rustcrypto")]
use crate::csr_rustcrypto as csr;
#[cfg(feature = "openssl")]
use crate::x509_openssl as x509;

// use crate::x509_rustcrypto as x509;
...
fn gen_init_devid_csr_ecc384(out_dir: &str) {
    let key_usage =
        x509_cert::ext::pkix::KeyUsage(x509_cert::ext::pkix::KeyUsages::KeyCertSign.into());
    let bldr = csr::CsrTemplateBuilder::<ecdsa::SigningKey<p384::NistP384>>::new()
