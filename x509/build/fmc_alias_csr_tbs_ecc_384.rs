...
impl FmcAliasCsrTbsEcc384 {
    ...
    const TCB_INFO_DEVICE_INFO_HASH_OFFSET: usize = 409usize;
    const TCB_INFO_FMC_TCI_OFFSET: usize = 507usize;
    const UEID_OFFSET: usize = 323usize;
    const TCB_INFO_FLAGS_OFFSET: usize = 460usize;
    const TCB_INFO_FMC_SVN_OFFSET: usize = 489usize;
    const TCB_INFO_FMC_SVN_FUSES_OFFSET: usize = 391usize;
    ...
    const TBS_TEMPLATE: [u8; Self::TBS_TEMPLATE_LEN] = [
        48u8, 130u8, 2u8, 49u8, 2u8, 1u8, 0u8, 48u8, 115u8, 49u8, 38u8, 48u8, 36u8, 6u8, 3u8, 85u8,
        ...
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 160u8, 130u8, 1u8, 61u8, 48u8, 130u8, 1u8, 57u8, 6u8, 9u8, 42u8, 134u8,
        72u8, 134u8, 247u8, 13u8, 1u8, 9u8, 14u8, 49u8, 130u8, 1u8, 42u8, 48u8, 130u8, 1u8, 38u8,
