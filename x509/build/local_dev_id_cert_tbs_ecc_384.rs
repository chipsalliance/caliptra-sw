...
impl LocalDevIdCertTbsEcc384 {
    ...
    const TBS_TEMPLATE_BEFORE_KEY: [u8; Self::PUBLIC_KEY_OFFSET] = [
        ...
        116u8, 114u8, 97u8, 32u8, 82u8, 79u8, 77u8, 32u8, 50u8, 46u8, 49u8, 46u8, 51u8, 32u8, 69u8,
        ...
        46u8, 49u8, 46u8, 51u8, 32u8, 69u8, 99u8, 99u8, 51u8, 56u8, 52u8, 32u8, 76u8, 68u8, 101u8,
