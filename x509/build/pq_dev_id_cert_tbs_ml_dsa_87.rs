...
--"]
pub struct PqDevIdCertTbsMlDsa87Params<'a> {
...
impl<'a> PqDevIdCertTbsMlDsa87Params<'a> {
...
pub struct PqDevIdCertTbsMlDsa87 {
    tbs: [u8; Self::TBS_TEMPLATE_LEN],
}
impl PqDevIdCertTbsMlDsa87 {
    const PUBLIC_KEY_OFFSET: usize = 334usize;
    const SUBJECT_SN_OFFSET: usize = 248usize;
    const ISSUER_SN_OFFSET: usize = 96usize;
    const SERIAL_NUMBER_OFFSET: usize = 11usize;
    const SUBJECT_KEY_ID_OFFSET: usize = 3012usize;
    const AUTHORITY_KEY_ID_OFFSET: usize = 3045usize;
    const UEID_OFFSET: usize = 2984usize;
    ...
    pub const TBS_TEMPLATE_LEN: usize = 3065usize;
    const TBS_TEMPLATE_BEFORE_PLACEHOLDER: [u8; 334usize] = [
        48u8, 130u8, 11u8, 245u8, 160u8, 3u8, 2u8, 1u8, 2u8, 2u8, 20u8, 95u8, 95u8, 95u8, 95u8,
        ...
        105u8, 112u8, 116u8, 114u8, 97u8, 32u8, 49u8, 46u8, 48u8, 32u8, 77u8, 108u8, 68u8, 115u8,
        97u8, 56u8, 55u8, 32u8, 80u8, 81u8, 68u8, 101u8, 118u8, 73u8, 68u8, 49u8, 73u8, 48u8, 71u8,
        ...
        95u8, 48u8, 114u8, 49u8, 37u8, 48u8, 35u8, 6u8, 3u8, 85u8, 4u8, 3u8, 12u8, 28u8, 67u8,
        97u8, 108u8, 105u8, 112u8, 116u8, 114u8, 97u8, 32u8, 49u8, 46u8, 48u8, 32u8, 77u8, 108u8,
        68u8, 115u8, 97u8, 56u8, 55u8, 32u8, 80u8, 81u8, 68u8, 101u8, 118u8, 73u8, 68u8, 49u8,
        73u8, 48u8, 71u8, 6u8, 3u8, 85u8, 4u8, 5u8, 19u8, 64u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 48u8, 130u8,
        10u8, 50u8, 48u8, 11u8, 6u8, 9u8, 96u8, 134u8, 72u8, 1u8, 101u8, 3u8, 4u8, 3u8, 19u8, 3u8,
        130u8, 10u8, 33u8, 0u8,
    ];
    const TBS_TEMPLATE_AFTER_PLACEHOLDER: [u8; 139usize] = [
        163u8, 129u8, 136u8, 48u8, 129u8, 133u8, 48u8, 18u8, 6u8, 3u8, 85u8, 29u8, 19u8, 1u8, 1u8,
    ...
    const TBS_TEMPLATE: [u8; Self::TBS_TEMPLATE_LEN] = {
        ...
        let mut i = 0;
        while i < after.len() {
            result[2926usize + i] = after[i];
            i += 1;
        }
        result
    };
    pub fn new(params: &PqDevIdCertTbsMlDsa87Params) -> Self {
        let mut tbs = [0x5F_u8; Self::TBS_TEMPLATE_LEN];
        tbs[..334usize].copy_from_slice(&Self::TBS_TEMPLATE_BEFORE_PLACEHOLDER);
        tbs[2926usize..].copy_from_slice(&Self::TBS_TEMPLATE_AFTER_PLACEHOLDER);
    ...
    fn apply(&mut self, params: &PqDevIdCertTbsMlDsa87Params) {
        #[inline(always)]
        fn apply_slice<const OFFSET: usize, const LEN: usize>(
            buf: &mut [u8; 3065usize],
            val: &[u8; LEN],
        ) {
