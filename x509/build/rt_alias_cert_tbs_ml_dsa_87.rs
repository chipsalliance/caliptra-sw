...
impl RtAliasCertTbsMlDsa87 {
    ...
    const TCB_INFO_RT_TCI_OFFSET: usize = 3061usize;
    const SERIAL_NUMBER_OFFSET: usize = 11usize;
    const SUBJECT_KEY_ID_OFFSET: usize = 3151usize;
    const AUTHORITY_KEY_ID_OFFSET: usize = 3184usize;
    const UEID_OFFSET: usize = 2989usize;
    const NOT_BEFORE_OFFSET: usize = 166usize;
    const NOT_AFTER_OFFSET: usize = 183usize;
    const TCB_INFO_FW_SVN_OFFSET: usize = 3043usize;
    ...
    const TBS_TEMPLATE: [u8; Self::TBS_TEMPLATE_LEN] = [
        ...
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 163u8, 130u8, 1u8, 15u8, 48u8, 130u8, 1u8, 11u8,
        48u8, 18u8, 6u8, 3u8, 85u8, 29u8, 19u8, 1u8, 1u8, 255u8, 4u8, 8u8, 48u8, 6u8, 1u8, 1u8,
        255u8, 2u8, 1u8, 4u8, 48u8, 14u8, 6u8, 3u8, 85u8, 29u8, 15u8, 1u8, 1u8, 255u8, 4u8, 4u8,
        3u8, 2u8, 2u8, 132u8, 48u8, 31u8, 6u8, 6u8, 103u8, 129u8, 5u8, 5u8, 4u8, 4u8, 4u8, 21u8,
        48u8, 19u8, 4u8, 17u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 48u8, 18u8, 6u8, 3u8, 85u8, 29u8, 37u8, 4u8, 11u8,
        48u8, 9u8, 6u8, 7u8, 103u8, 129u8, 5u8, 5u8, 4u8, 100u8, 12u8, 48u8, 112u8, 6u8, 6u8,
