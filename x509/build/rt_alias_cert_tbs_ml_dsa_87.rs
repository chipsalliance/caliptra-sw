...
impl RtAliasCertTbsMlDsa87 {
    ...
    const ISSUER_SN_OFFSET: usize = 103usize;
    const TCB_INFO_RT_TCI_OFFSET: usize = 3071usize;
    const SERIAL_NUMBER_OFFSET: usize = 11usize;
    const SUBJECT_KEY_ID_OFFSET: usize = 3161usize;
    const AUTHORITY_KEY_ID_OFFSET: usize = 3194usize;
    const UEID_OFFSET: usize = 2999usize;
    const NOT_BEFORE_OFFSET: usize = 171usize;
    const NOT_AFTER_OFFSET: usize = 188usize;
    const TCB_INFO_FW_SVN_OFFSET: usize = 3053usize;
    ...
    pub const TBS_TEMPLATE_LEN: usize = 3214usize;
    const TBS_TEMPLATE_BEFORE_KEY: [u8; Self::PUBLIC_KEY_OFFSET] = [
        48u8, 130u8, 12u8, 138u8, 160u8, 3u8, 2u8, 1u8, 2u8, 2u8, 20u8, 95u8, 95u8, 95u8, 95u8,
        ...
        121u8, 49u8, 44u8, 48u8, 42u8, 6u8, 3u8, 85u8, 4u8, 3u8, 12u8, 35u8, 67u8, 97u8, 108u8,
        105u8, 112u8, 116u8, 114u8, 97u8, 32u8, 70u8, 87u8, 32u8, 50u8, 46u8, 49u8, 46u8, 48u8,
        32u8, 77u8, 108u8, 68u8, 115u8, 97u8, 56u8, 55u8, 32u8, 70u8, 77u8, 67u8, 32u8, 65u8,
        ...
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 48u8, 120u8, 49u8, 43u8, 48u8,
        41u8, 6u8, 3u8, 85u8, 4u8, 3u8, 12u8, 34u8, 67u8, 97u8, 108u8, 105u8, 112u8, 116u8, 114u8,
        97u8, 32u8, 70u8, 87u8, 32u8, 50u8, 46u8, 49u8, 46u8, 48u8, 32u8, 77u8, 108u8, 68u8, 115u8,
