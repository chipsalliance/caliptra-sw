...
use crate as caliptra_emu_bus;
use crate::{Bus, BusError, ReadWriteRegister, ReadWriteRegisterArray, Register};
...
impl Pic {
    ...
    pub fn mmio_regs(&self) -> PicMmioRegisters {
        PicMmioRegisters {
            pic: self.pic.clone(),
        }
    }
