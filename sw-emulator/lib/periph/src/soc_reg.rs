...
struct SocRegistersImpl {
    ...
    ss_dbg_service_reg_rsp: ReadWriteRegister<u32, SsDbgManufServiceRegRsp::Register>,
...
impl SocRegistersImpl {
    ...
    pub fn new(mailbox: MailboxInternal, iccm: Iccm, mut args: CaliptraRootBusArgs) -> Self {
        ...
        let regs = Self {
            ...
            ss_dbg_service_reg_rsp: ReadWriteRegister::new(0),
    ...
    fn bus_poll(&mut self) {
        ...
        if self.timer.fired(&mut self.op_fw_read_complete_action) {
            let soc_mbox = self
                .mailbox
                .as_external(MailboxRequester::SocUser(1))
                .regs();
