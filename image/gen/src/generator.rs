...
impl<Crypto: ImageGeneratorCrypto> ImageGenerator<Crypto> {
        ...
        E: ImageGeneratorExecutable,
    {
        ...
        if config.fw_image_type == FwVerificationPqcKeyType::Mldsa {
        ...
        let manifest = ImageManifest {
            ...
            pqc_key_type: config.fw_image_type.into(),
            reserved: [0u8; 3],
            preamble,
            header,
            fmc: fmc_toc,
        ...
        E: ImageGeneratorExecutable,
    {
        ...
        if let Some(priv_keys) = config.vendor_config.priv_keys {
            ...
            if config.fw_image_type == FwVerificationPqcKeyType::Lms {
        ...
        let pqc_pub_key = match config.fw_image_type {
