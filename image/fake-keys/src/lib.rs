...
use caliptra_image_types::{
    ...
    ImageOwnerPubKeys, ImageScalar, ImageVendorPrivKeys, ImageVendorPubKeys, IMAGE_LMS_OTS_TYPE,
    IMAGE_LMS_TREE_TYPE,
};
...
pub const VENDOR_ECC_KEY_0_PRIVATE: ImageEccPrivKey = ImageScalar([
...
pub const VENDOR_ECC_KEY_1_PRIVATE: ImageEccPrivKey = ImageScalar([
...
pub const VENDOR_ECC_KEY_2_PRIVATE: ImageEccPrivKey = ImageScalar([
...
pub const VENDOR_ECC_KEY_3_PRIVATE: ImageEccPrivKey = ImageScalar([
...
pub const OWNER_ECC_KEY_PRIVATE: ImageEccPrivKey = ImageScalar([
