...
pub const VENDOR_LMS_KEY0_PRIVATE: ImageLmsPrivKey = ImageLmsPrivKey {
    ...
    seed: [
        0x1a, 0x07, 0x61, 0x91, 0x06, 0xdc, 0x6d, 0xb3, 0xca, 0x37, 0xea, 0x35, 0x8e, 0xfc, 0x44,
        0x82, 0x1c, 0xcf, 0x73, 0xd9, 0xf7, 0x7c, 0xec, 0x85,
    ],
};
pub const VENDOR_LMS_KEY0_PUBLIC: ImageLmsPublicKey = ImageLmsPublicKey {
    ...
    digest: [
        0x62, 0xba, 0x32, 0xf9, 0x2a, 0x2a, 0xf6, 0xab, 0xe3, 0xd9, 0x1b, 0x69, 0x60, 0xc4, 0x2d,
        0xc3, 0xad, 0xda, 0xa6, 0xa9, 0x97, 0x8f, 0x9b, 0x75,
    ],
};
...
pub const VENDOR_LMS_KEY1_PRIVATE: ImageLmsPrivKey = ImageLmsPrivKey {
    ...
    seed: [
        0x37, 0x7d, 0x88, 0x8a, 0x2e, 0xf2, 0xe9, 0x00, 0x75, 0x88, 0xb7, 0x00, 0x3c, 0x3c, 0x63,
        0x76, 0x2a, 0x26, 0x95, 0x8e, 0xce, 0xb0, 0xb8, 0xaf,
    ],
};
pub const VENDOR_LMS_KEY1_PUBLIC: ImageLmsPublicKey = ImageLmsPublicKey {
    ...
    digest: [
        0x37, 0xea, 0x50, 0x2e, 0x1b, 0x88, 0xaf, 0x66, 0x43, 0xc3, 0x01, 0x45, 0x51, 0x7c, 0x06,
        0x0d, 0xe6, 0x16, 0x89, 0x0b, 0x6b, 0x23, 0x77, 0x1f,
    ],
};
pub const VENDOR_LMS_KEY2_PRIVATE: ImageLmsPrivKey = ImageLmsPrivKey {
    ...
    seed: [
        0x01, 0x7a, 0x97, 0x09, 0xc3, 0x7a, 0x3d, 0x0d, 0x3c, 0x06, 0x91, 0xb6, 0x81, 0xcf, 0x6b,
        0xf3, 0xda, 0x90, 0x8c, 0x82, 0xa0, 0x84, 0xfa, 0x81,
    ],
};
pub const VENDOR_LMS_KEY2_PUBLIC: ImageLmsPublicKey = ImageLmsPublicKey {
    ...
    digest: [
        0x51, 0x77, 0x2a, 0x27, 0xd1, 0x34, 0x57, 0xc7, 0x6a, 0x7f, 0x6f, 0x34, 0xdc, 0x32, 0x5f,
        0x10, 0x55, 0xac, 0x53, 0x7e, 0xf7, 0x6a, 0x67, 0x2a,
    ],
};
pub const VENDOR_LMS_KEY3_PRIVATE: ImageLmsPrivKey = ImageLmsPrivKey {
    ...
    seed: [
        0xba, 0x4f, 0xca, 0x0b, 0x84, 0x9c, 0x3b, 0x2d, 0xcc, 0x6b, 0x31, 0x5d, 0xf2, 0x8e, 0x00,
        0xe9, 0xe2, 0xe5, 0xd8, 0x6f, 0x68, 0x57, 0x72, 0xd3,
    ],
};
pub const VENDOR_LMS_KEY3_PUBLIC: ImageLmsPublicKey = ImageLmsPublicKey {
    ...
    digest: [
        0xf2, 0x21, 0xa5, 0x79, 0x51, 0xb8, 0x9e, 0x74, 0xd3, 0x8a, 0xa6, 0x4b, 0x04, 0xb7, 0x26,
        0x00, 0xda, 0xe4, 0x2b, 0xab, 0xcd, 0x0f, 0xb0, 0x76,
    ],
};
pub const OWNER_LMS_KEY_PRIVATE: ImageLmsPrivKey = ImageLmsPrivKey {
    ...
    otstype: 0x07,
    id: [
        0xb3, 0x2a, 0xe0, 0x28, 0xb2, 0x9a, 0x45, 0xc6, 0xec, 0x72, 0xc9, 0xbf, 0xc9, 0x3d, 0xbe,
        0xfb,
    ],
    seed: [
        0x99, 0x7d, 0x78, 0x8b, 0x6a, 0x0b, 0x40, 0xf5, 0xab, 0xad, 0xf7, 0xb5, 0x21, 0x2d, 0xbd,
        0xfd, 0xe9, 0x9c, 0x96, 0xef, 0xb5, 0x45, 0xd3, 0x9b,
    ],
};
pub const OWNER_LMS_KEY_PUBLIC: ImageLmsPublicKey = ImageLmsPublicKey {
    ...
    digest: [
        0x62, 0x04, 0xfe, 0x7d, 0xc0, 0xe8, 0x70, 0xc2, 0xf0, 0x72, 0xe4, 0x87, 0x9b, 0x15, 0x61,
        0x95, 0xda, 0x23, 0x23, 0x1f, 0xb1, 0x0a, 0xdd, 0x54,
    ],
};
