...
///    available.
#[derive(Clone, Copy)]
pub struct RegRef<TReg: RegType, TMmio: Mmio = RealMmio> {
    mmio: TMmio,
    ptr: *mut TReg::Raw,
}
...
impl<TReg: RegType> RegRef<TReg, RealMmio> {
...
impl<TReg: ReadableReg, TMmio: Mmio> RegRef<TReg, TMmio> {
    ...
    ///
    /// ```no_run
    /// use ureg::{ReadableReg, RegRef, RegType};
    ...
    /// impl RegisterBlock {
    ///     fn control(&self) -> RegRef<ControlReg> { return unsafe { RegRef::new(self.0.add(4)) } }
    /// }
    ///
...
impl<TReg: ResettableReg + WritableReg, TMmio: Mmio> RegRef<TReg, TMmio> {
    ...
    ///
    /// ```no_run
    /// use ureg::{ResettableReg, WritableReg, RegRef, RegType};
    /// // Note: these types are typically generated by ureg-codegen.
    /// struct ControlReg();
    /// impl RegType for ControlReg {
    ///     type Raw = u32;
...
impl<TReg: ReadableReg + WritableReg, TMmio: Mmio> RegRef<TReg, TMmio> {
    ...
    ///
    /// ```no_run
    /// use ureg::{ReadableReg, ResettableReg, WritableReg, RegRef, RegType};
    ///
    /// // Note: these types are typically generated by ureg-codegen.
    /// struct ControlReg();
    /// impl RegType for ControlReg {
...
impl<const LEN: usize, TReg: ReadableReg, TMmio: Mmio> Array<LEN, RegRef<TReg, TMmio>> {
    ...
    ///
    /// ```no_run
    /// use ureg::{Array, ReadableReg, RegRef, RegType};
    ///
    /// // Note: these types are typically generated by ureg-codegen.
    /// struct ValueReg();
    ...
    /// struct RegisterBlock(*mut u32);
    /// impl RegisterBlock {
    ///     fn value(&self) -> Array<4, RegRef<ValueReg>> { return unsafe { Array::new(self.0.add(16)) } }
    /// }
    /// let regs = RegisterBlock(0x3002_0000 as *mut u32);
    ///
...
impl<const LEN: usize, TReg: WritableReg, TMmio: Mmio> Array<LEN, RegRef<TReg, TMmio>> {
    ...
    ///
    /// ```no_run
    /// use ureg::{Array, WritableReg, RegRef, RegType};
    ///
    /// // Note: these types are typically generated by ureg-codegen.
    /// struct ValueReg();
    /// impl RegType for ValueReg{
