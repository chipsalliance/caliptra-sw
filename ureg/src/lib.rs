...
impl<TReg: ResettableReg + WritableReg, TMmio: Mmio> RegRef<TReg, TMmio> {
    ...
    ///
    /// ```no_run
    /// use ureg::{ResettableReg, WritableReg, RealMmio, RegRef, RegType};
    /// // Note: these types are typically generated by ureg-codegen.
    /// struct ControlReg();
    /// impl RegType for ControlReg {
    ///     type Raw = u32;
...
impl<TReg: ReadableReg + WritableReg, TMmio: Mmio> RegRef<TReg, TMmio> {
    ...
    ///
    /// ```no_run
    /// use ureg::{ReadableReg, ResettableReg, WritableReg, RealMmio, RegRef, RegType};
    ///
    /// // Note: these types are typically generated by ureg-codegen.
    /// struct ControlReg();
    /// impl RegType for ControlReg {
...
impl<const LEN: usize, TReg: WritableReg, TMmio: Mmio> Array<LEN, RegRef<TReg, TMmio>> {
    ...
    ///
    /// ```no_run
    /// use ureg::{Array, WritableReg, RegRef, RealMmio, RegType};
    ///
    /// // Note: these types are typically generated by ureg-codegen.
    /// struct ValueReg();
    /// impl RegType for ValueReg{
