...
impl<TReg: ReadableReg, TMmio: Mmio> RegRef<TReg, TMmio> {
    ...
    ///
    /// ```no_run
    /// use caliptra_ureg::{ReadableReg, RegRef, RealMmio, RegType};
    /// // Note: these types are typically generated by caliptra_ureg-codegen.
    /// struct ControlReg();
...
impl<TReg: ResettableReg + WritableReg, TMmio: MmioMut> RegRef<TReg, TMmio> {
    ...
    ///
    /// ```no_run
    /// use caliptra_ureg::{ResettableReg, WritableReg, RealMmioMut, RegRef, RegType};
    /// // Note: these types are typically generated by caliptra_ureg-codegen.
    /// struct ControlReg();
    /// impl RegType for ControlReg {
    ///     type Raw = u32;
...
impl<TReg: ReadableReg + WritableReg, TMmio: MmioMut> RegRef<TReg, TMmio> {
    ...
    ///
    /// ```no_run
    /// use caliptra_ureg::{ReadableReg, ResettableReg, WritableReg, RealMmioMut, RegRef, RegType};
    ///
    /// // Note: these types are typically generated by caliptra_ureg-codegen.
    /// struct ControlReg();
    /// impl RegType for ControlReg {
    ...
    Array<LEN, RegRef<TReg, TMmio>>
{
    ...
    ///
    /// ```no_run
    /// use caliptra_ureg::{Array, ReadableReg, RealMmio, RegRef, RegType};
    ///
    /// // Note: these types are typically generated by caliptra_ureg-codegen.
    /// struct ValueReg();
    ...
    > Array<LEN, RegRef<TReg, TMmio>>
{
    ...
    ///
    /// ```no_run
    /// use caliptra_ureg::{Array, WritableReg, RegRef, RealMmioMut, RegType};
    ///
    /// // Note: these types are typically generated by caliptra_ureg-codegen.
    /// struct ValueReg();
    /// impl RegType for ValueReg{
...
mod tests {
    ...
    // cargo +nightly miri test -p caliptra_ureg --lib
