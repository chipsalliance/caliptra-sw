...
use caliptra_drivers::{
    ...
    PersistentDataAccessor, Recovery, Sha1, Sha256, Sha2_512_384Acc, Sha384, SocIfc, Trng,
};
use caliptra_error::CaliptraResult;
use caliptra_registers::{
    csrng::CsrngReg, doe::DoeReg, dv::DvReg, ecc::EccReg, entropy_src::EntropySrcReg,
    hmac::HmacReg, kv::KvReg, mbox::MboxCsr, pv::PvReg, recovery::RecoveryReg, sha256::Sha256Reg,
...
impl RomEnv {
    pub unsafe fn new_from_registers() -> CaliptraResult<Self> {
        ...
        Ok(Self {
            ...
            trng,
            recovery: Recovery::new(RecoveryReg::new()),
