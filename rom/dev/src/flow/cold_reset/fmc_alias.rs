...
impl FmcAliasLayer {
    ...
    pub fn derive(
        ...
        let mut measurement = env.non_crypto.pcr_bank.read_pcr(PCR_ID_FMC_CURRENT);
    ...
    fn generate_cert_sig_ecc(
        ...
        let flags = dice::make_flags(
            env.non_crypto.soc_ifc.lifecycle(),
            env.non_crypto.soc_ifc.debug_locked(),
        );
