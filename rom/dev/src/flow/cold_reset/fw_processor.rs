...
impl FirmwareProcessor {
    ...
    fn load_manifest_from_mcu(
        ...
        let manifest_size_words = (manifest_buf.len() + 3) / 4; // Round up to word boundary
    ...
    fn load_image_from_mcu(
        ...
        let fmc_size_words = (fmc_dest.len() + 3) / 4; // Round up to word boundary
        ...
        let runtime_size_words = (runtime_dest.len() + 3) / 4; // Round up to word boundary
