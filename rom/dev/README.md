...
3. ROM then retrieves the SS_OTP_FC_UDS_GRANULARITY from `CPTRA_HW_CONFIG` register Bit6 to learn if the fuse row is accessible with 32-bit or 64-bit granularity.
