...
| MLDSA CSR Size | 4            | Size of the ECC CSR in bytes.                                                                   |
| MLDSA CSR      | n            | MLDSA CSR bytes. Actual CSR size is indicated by 'MLDSA CSR Size'.                              |
| MLDSA CSR MAC  | 64           | MLDSA CSR HMAC-512 MAC. MAC is computed over actual CSR bytes.                                  |
