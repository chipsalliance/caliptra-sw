...
3. ROM enters a polling loop, awaiting a `AUTH_DEBUG_UNLOCK_REQ` command (0x50445552) on the mailbox. The payload for this command is of the following format:
