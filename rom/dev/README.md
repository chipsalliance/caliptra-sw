...
Note that KvSlot4 is generally used as a temporary location for derived keying material during ECC keygen.
...
3.	Derive ECC Key Pair using CDI in Key Vault Slot6 and store the generated private key in KeySlot7
    ...
    `IDevIDSeed = hmac384_kdf(KvSlot6, b"idevid_keygen", KvSlot4)`
    `IDevIdPubKey = ecc384_keygen(KvSlot4, KvSlot7)`
    `kv_clear(KvSlot4)`
...
3.	Derive ECC Key Pair using CDI in Key Vault Slot6 and store the generated private key in KeySlot5.
    ...
    `LDevIDSeed = hmac384_kdf(KvSlot6, b"ldevid_keygen", KvSlot4)`
    `LDevIdPubKey = ecc384_keygen(KvSlot4, KvSlot5)`
    `kv_clear(KvSlot4)`
...
3.	Derive Alias FMC ECC Key Pair using CDI in Key Vault Slot6 and store the generated private key in KeySlot7.
    ...
    `AliasFmcSeed = hmac384_kdf(KvSlot6, b"fmc_alias_keygen", KvSlot4)`
    `AliasFmcPubKey = ecc384_keygen(KvSlot4, KvSlot7)`
    `kv_clear(KvSlot4)`
