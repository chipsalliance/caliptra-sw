...
Sha256 Driver | DRIVER_SHA256_INVALID_SLICE       | 0x00020003
Sha256 Driver | DRIVER_SHA256_INDEX_OUT_OF_BOUNDS | 0x00020004
<br>
Sha2_512_384 Driver | DRIVER_SHA2_512_384_READ_DATA_KV_READ    | 0x00030001
Sha2_512_384 Driver | DRIVER_SHA2_512_384_READ_DATA_KV_WRITE   | 0x00030002
Sha2_512_384 Driver | DRIVER_SHA2_512_384_READ_DATA_KV_UNKNOWN | 0x00030003
Sha2_512_384 Driver | DRIVER_SHA2_512_384_INVALID_STATE_ERR    | 0x00030007
Sha2_512_384 Driver | DRIVER_SHA2_512_384_MAX_DATA_ERR         | 0x00030008
Sha2_512_384 Driver | DRIVER_SHA2_512_384_INVALID_KEY_SIZE     | 0x00030009
Sha2_512_384 Driver | DRIVER_SHA2_512_384_INVALID_SLICE        | 0x0003000A
Sha2_512_384 Driver | DRIVER_SHA2_512_384_INDEX_OUT_OF_BOUNDS  | 0x0003000B
<br>
Hmac Driver | DRIVER_HMAC_READ_KEY_KV_READ     | 0x00040001
Hmac Driver | DRIVER_HMAC_READ_KEY_KV_WRITE    | 0x00040002
Hmac Driver | DRIVER_HMAC_READ_KEY_KV_UNKNOWN  | 0x00040003
Hmac Driver | DRIVER_HMAC_READ_DATA_KV_READ    | 0x00040004
Hmac Driver | DRIVER_HMAC_READ_DATA_KV_WRITE   | 0x00040005
Hmac Driver | DRIVER_HMAC_READ_DATA_KV_UNKNOWN | 0x00040006
Hmac Driver | DRIVER_HMAC_WRITE_TAG_KV_READ    | 0x00040007
Hmac Driver | DRIVER_HMAC_WRITE_TAG_KV_WRITE   | 0x00040008
Hmac Driver | DRIVER_HMAC_WRITE_TAG_KV_UNKNOWN | 0x00040009
Hmac Driver | DRIVER_HMAC_INVALID_STATE        | 0x0004000b
Hmac Driver | DRIVER_HMAC_MAX_DATA             | 0x0004000c
Hmac Driver | DRIVER_HMAC_INVALID_SLICE        | 0x0004000d
Hmac Driver | DRIVER_HMAC_INDEX_OUT_OF_BOUNDS  | 0x0004000e
<br>
...
Verifier Library | IMAGE_VERIFIER_ERR_OWNER_ECC_PUB_KEY_INVALID_ARG           | 0x000b0019
Verifier Library | IMAGE_VERIFIER_ERR_OWNER_ECC_SIGNATURE_INVALID_ARG         | 0x000b001a
Verifier Library | IMAGE_VERIFIER_ERR_VENDOR_ECC_PUB_KEY_INVALID_ARG          | 0x000b001b
...
Verifier Library | IMAGE_VERIFIER_ERR_FIRMWARE_SVN_GREATER_THAN_MAX_SUPPORTED | 0x000b002c
Verifier Library | IMAGE_VERIFIER_ERR_FIRMWARE_SVN_LESS_THAN_FUSE             | 0x000b002e
Verifier Library | IMAGE_VERIFIER_ERR_IMAGE_LEN_MORE_THAN_BUNDLE_SIZE         | 0x000b002f
Verifier Library | IMAGE_VERIFIER_ERR_VENDOR_PQC_PUB_KEY_INDEX_MISMATCH       | 0x000b0030
Verifier Library | IMAGE_VERIFIER_ERR_VENDOR_LMS_VERIFY_FAILURE               | 0x000b0031
Verifier Library | IMAGE_VERIFIER_ERR_VENDOR_PQC_PUB_KEY_INDEX_OUT_OF_BOUNDS  | 0x000b0032
Verifier Library | IMAGE_VERIFIER_ERR_VENDOR_LMS_SIGNATURE_INVALID            | 0x000b0033
Verifier Library | IMAGE_VERIFIER_ERR_FMC_RUNTIME_LOAD_ADDR_OVERLAP           | 0x000b0034
<br>
...
CSRNG Driver | DRIVER_CSRNG_OTHER_HEALTH_CHECK_FAILED  | 0x000d0006
CSRNG Driver | DRIVER_CSRNG_REPCNT_HEALTH_CHECK_FAILED | 0x000d0007
CSRNG Driver | DRIVER_CSRNG_ADAPTP_HEALTH_CHECK_FAILED | 0x000d0008
CSRNG Driver | DRIVER_CSRNG_MODULE_ALREADY_ENABLED     | 0x000d0009
<br>
...
ROM | FMC_ALIAS_CERT_VERIFY_FAILURE               | 0x01030001
...
ROM | ROM_GLOBAL_PCR_LOG_EXHAUSTED                | 0x01050006
ROM | ROM_GLOBAL_FUSE_LOG_INVALID_ENTRY_ID        | 0x01050007
ROM | ROM_GLOBAL_FUSE_LOG_UNSUPPORTED_DATA_LENGTH | 0x01050008
ROM | ROM_GLOBAL_UNSUPPORTED_LDEVID_TBS_SIZE      | 0x01050009
ROM | ROM_GLOBAL_UNSUPPORTED_FMCALIAS_TBS_SIZE    | 0x0105000A
<br>
...
KAT | KAT_SHA2_512_384_ACC_DIGEST_MISMATCH         | 0x90050003
...
KAT | KAT_CSRNG_INSTANTIATE_FAILURE                | 0x900C0001
KAT | KAT_CSRNG_GENERATE_FAILURE                   | 0x900C0002
KAT | KAT_CSRNG_DIGEST_MISMATCH                    | 0x900C0003
KAT | KAT_CSRNG_RESTORE_FAILURE                    | 0x900C0004
KAT | KAT_CSRNG_RESEED_FAILURE                     | 0x900C0005
...
Verifier Library | IMAGE_VERIFIER_ERR_UPDATE_RESET_VENDOR_ECC_PUB_KEY_IDX_MISMATCH | 0x000b001e
