...
Test Scenario| Test Name | Runtime Error Code
---|---|---
Increments the PCR reset counter and verifies an ECC PCR quote with the FMC Alias key for 2.1 or the certificate-bound dedicated key for 2.2 | **test_pcr_quote_ecc** | N/A
Increments the PCR reset counter and verifies an MLDSA PCR quote with the FMC Alias key for 2.1 or the certificate-bound dedicated key for 2.2 | **test_pcr_quote_mldsa** | N/A
