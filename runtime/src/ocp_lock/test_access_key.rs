...
impl TestAccessKeyCmd {
    ...
    pub(crate) fn execute(
        ...
        let mut staging_buffer = [0u32; core::mem::size_of::<OcpLockTestAccessKeyReq>() / 4];
        let cmd = stage_mailbox_request::<OcpLockTestAccessKeyReq>(cmd_args, &mut staging_buffer)?;
