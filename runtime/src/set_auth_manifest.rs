...
use caliptra_auth_man_types::{
    AuthManifestFlags, AuthManifestImageMetadataSet, AuthManifestImageMetadataSetHeader,
    AuthManifestImageMetadataSetWithPublicKeys, AuthManifestPreamble, AUTH_MANIFEST_MARKER,
};
...
impl SetAuthManifestCmd {
    ...
    pub(crate) fn execute(drivers: &mut Drivers, cmd_args: &[u8]) -> CaliptraResult<MailboxResp> {
        ...
        if manifest_size > SetAuthManifestReq::MAX_SIZE {
