...
use crate::test_set_auth_manifest::{
    create_auth_manifest_with_metadata, create_auth_manifest_with_metadata_with_config,
};
...
fn create_recovery_auth_manifest(
    ...
    create_auth_manifest_with_metadata_with_config(metadata, manifest_flags, pqc_key_type, 0)
}
