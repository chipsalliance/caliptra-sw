...
require (
	github.com/chipsalliance/caliptra-dpe/verification/client v0.0.0-20240227181801-29d5ca397c66
	github.com/chipsalliance/caliptra-dpe/verification/testing v0.0.0-20240227181801-29d5ca397c66
)

require (
	github.com/chipsalliance/caliptra-dpe/verification/sim v0.0.0-20240227181801-29d5ca397c66 // indirect
