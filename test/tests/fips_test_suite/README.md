...
| zeroize_halt_check_no_output | TE03.07.02<br>TE09.28.03 | Enable hook to halt during zeroize in (runtime) shutdown command  <br>Issue shutdown command  <br>Attempt output to verify it is inhibited |
| zeroize_check_inaccessible | TE09.28.02 | Issue shutdown command  <br>Attempt use of module to verify use of SSPs is not possible |
...
## TEs Requiring Verification by Inspection
| TE  | Reason                                                                         |
| :----------------------- | :---------------------------------------------------------------------------------- |
| TE05.08.02   | Zeroization of intermediate values typically takes place in the HW and is triggered by the drivers. These intermediate values are not accessible to be able to prove they have been zeroized. Inspection of the drivers and RTL implementation will be necessary to prove this point.<br><br>**ROM Integrity Test:**<br>[ROM digest is zeroized](https://github.com/chipsalliance/caliptra-sw/blob/d6713db2a9d7d36409ff4c92e35f4ba7f56169df/rom/dev/src/main.rs#L242)<br><br>**FW Integrity Test:**<br>Intermediate values for crypto operations called in the [image verifier](https://github.com/chipsalliance/caliptra-sw/blob/rom-1.1.1/image/verify/src/verifier.rs) are zeroed in the drivers:<br>[Ecc384](https://github.com/chipsalliance/caliptra-sw/blob/d6713db2a9d7d36409ff4c92e35f4ba7f56169df/drivers/src/ecc384.rs#L602)<br>[LMS](https://github.com/chipsalliance/caliptra-sw/blob/d6713db2a9d7d36409ff4c92e35f4ba7f56169df/drivers/src/lms.rs#L609)<br>[Sha384](https://github.com/chipsalliance/caliptra-sw/blob/d6713db2a9d7d36409ff4c92e35f4ba7f56169df/drivers/src/sha384.rs#L118)
| TE09.28.04   | Understanding the zeroization requires inspection of HW functionality. However, the module is unreachable (as proven in zeroize_check_inaccessible) following the zeroization procedures.<br>On-demand zeroization is handled differently in ROM vs runtime<br>**ROM**: leverages the [fatal error handler](https://github.com/chipsalliance/caliptra-sw/blob/d6713db2a9d7d36409ff4c92e35f4ba7f56169df/rom/dev/src/main.rs#L365)<br>**Runtime**: [FipsModule::zeroize](https://github.com/chipsalliance/caliptra-sw/blob/cccf6419a5952f89c3aa270102edd5da9a11c5ac/runtime/src/fips.rs#L40)<br>These both invoke the same HW zeroize functionality for each component<br>[Ecc384](https://chipsalliance.github.io/caliptra-rtl/v1_1/internal-regs/?p=clp.ecc_reg.ECC_CTRL#ZEROIZE.desc)<br>[Hmac384](https://chipsalliance.github.io/caliptra-rtl/v1_1/internal-regs/?p=clp.hmac_reg.HMAC384_CTRL#ZEROIZE.desc)<br>[Sha256](https://chipsalliance.github.io/caliptra-rtl/v1_1/internal-regs/?p=clp.sha256_reg.SHA256_CTRL#ZEROIZE.desc)<br>[Sha384](https://chipsalliance.github.io/caliptra-rtl/v1_1/internal-regs/?p=clp.sha512_reg.SHA512_CTRL#ZEROIZE.desc)<br>[Sha384 Accelerator](https://chipsalliance.github.io/caliptra-rtl/v1_1/internal-regs/?p=clp.sha512_acc_csr.CONTROL#ZEROIZE.desc)<br>[KeyVault](https://chipsalliance.github.io/caliptra-rtl/v1_1/internal-regs/?p=clp.kv_reg.KEY_CTRL%5B0%5D#clear.desc)