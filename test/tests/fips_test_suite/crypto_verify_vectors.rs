...
// ============================================================
// ECDSA384 verify test vector
// Source: NIST/known-answer test data used in exec_cmd_ecdsa_verify
// ============================================================

pub const ECDSA384_MSG: [u8; 128] = [
...
pub const ECDSA384_PUB_KEY_X: [u8; 48] = [
...
pub const ECDSA384_PUB_KEY_Y: [u8; 48] = [
...
pub const ECDSA384_SIGNATURE_R: [u8; 48] = [
...
pub const ECDSA384_SIGNATURE_S: [u8; 48] = [
...
// ============================================================
// LMS verify test vectors
// Source: runtime integration tests (test_lms.rs MSG_1 + MSG_1_PUB_KEY_1 + MSG_1_KEY_1_SIG_1)
// ============================================================

// LMS parameter set constants
pub const LMS_N: usize = 6;
pub const LMS_P: usize = 51;
pub const LMS_H: usize = 15;

pub const LMS_MSG: [u8; 1024] = [
