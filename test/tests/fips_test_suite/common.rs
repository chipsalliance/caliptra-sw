...
const HW_EXP_CURRENT: HwExpVals = HwExpVals { hw_revision: 0x302 };
...
const ROM_EXP_2_0_1: RomExpVals = RomExpVals {
    rom_version: 0x1001, // 2.0.1
    ..ROM_EXP_2_0_0
};
...
const ROM_EXP_CURRENT: RomExpVals = RomExpVals { ..ROM_EXP_2_0_2 };
...
const RT_EXP_2_0_1: RtExpVals = RtExpVals {
    fmc_version: 0x1001,     // 2.0.1
    fw_version: 0x0200_0001, // 2.0.1
};

const RT_EXP_CURRENT: RtExpVals = RtExpVals { ..RT_EXP_2_0_1 };
...
pub fn parse_dpe_response(dpe_cmd: &mut Command, resp_bytes: &[u8]) -> Response {
    match dpe_cmd {
        ...
        Command::CertifyKey(CertifyKeyCommand::Mldsa87(_)) => {
            unimplemented!("MLDSA87 CertifyKey response parsing not yet implemented")
        }
        Command::Sign(SignCommand::Mldsa87(_)) => {
            unimplemented!("MLDSA87 Sign response parsing not yet implemented")
        }
    }
}
